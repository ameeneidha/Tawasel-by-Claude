...
- CRM now follows the same design-system direction from the uploaded pipeline template: live pipeline hero, real KPI cards, softer stage columns, initials-based lead cards, localized labels, and preserved stage movement/value editing/custom stage controls.
