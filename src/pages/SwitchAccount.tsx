...
export default function SwitchAccount() {
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-gray-900">Switch Account</h1>
        <p className="text-gray-500 mt-1">Manage and switch between your connected accounts.</p>
      </div>
      ...
      <div className="space-y-4">
        {accounts.map((account) => (
          <motion.div
            ...
            className={cn(
              ...
              account.current 
                ? "bg-[#25D366]/5 border-[#25D366]/20 ring-1 ring-[#25D366]/20" 
          ...
          >
            <div className="flex items-center gap-4">
              <div className={cn(
                ...
                account.current ? "bg-[#25D366] text-white" : "bg-gray-100 text-gray-600"
              )}>
                {account.name[0]}
              </div>
              <div>
        ...
        <button className="w-full p-4 rounded-2xl border border-dashed border-gray-200 text-gray-500 hover:border-[#25D366] hover:text-[#25D366] hover:bg-[#25D366]/5 transition-all flex items-center justify-center gap-2 font-medium">
