...
- CRM visual refresh: the pipeline now uses the uploaded board design direction with a live pipeline hero, real KPI cards, softer stage columns, initials-based lead cards, localized labels, and preserved stage movement/value editing/custom stage controls.
